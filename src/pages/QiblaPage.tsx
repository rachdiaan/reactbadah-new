...
const QiblaPage: React.FC = () => {
    ...
    return (
        <div className="flex flex-col space-y-6 max-w-4xl mx-auto pb-10">
            ...
            {/* Error / Loading */}
            {error && (
                <div className="bg-red-50 text-red-600 dark:bg-red-900/20 dark:text-red-400 p-4 rounded-xl text-sm border border-red-100 dark:border-red-900/30">{error}</div>
            )}
            {!location && !error && (
            ...
            {location && (
                <div className="relative flex justify-center items-center py-10 overflow-hidden min-h-[400px]">
                    ...
                    <div className="absolute inset-0 opacity-5 pointer-events-none dark:invert"
                    ...
                    <div className="relative w-72 h-72 md:w-96 md:h-96">
                        ...
                        >
                            ...
                            <div className="absolute top-4 left-1/2 -translate-x-1/2 text-center z-10">
                                <div className="w-8 h-8 rounded-full border-2 border-red-500 flex items-center justify-center bg-white dark:bg-slate-700">
                            ...
                            <div className="absolute top-1/2 right-4 -translate-y-1/2 text-center z-10">
                                <div className="w-8 h-8 rounded-full border border-gray-200 dark:border-gray-600 flex items-center justify-center bg-white dark:bg-slate-700">
                            ...
                            {/* Center Dot */}
                            <div className="absolute top-1/2 left-1/2 w-4 h-4 bg-primary rounded-full -translate-x-1/2 -translate-y-1/2 z-20 shadow-lg border-2 border-white dark:border-slate-800"></div>
                                ...
                                <>
                                    ...
                                    >
                                        <div className="absolute top-[15%] left-1/2 -translate-x-1/2 flex flex-col items-center">
                                            <div className="bg-primary rounded-lg p-1.5 shadow-lg transform -rotate-45 border-2 border-white dark:border-slate-800">
                        ...
                        <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 font-bold text-3xl text-gray-800 dark:text-white tracking-tighter">
                            {Math.round(heading)}°
                        </div>
                    </div>
                </div>
            ...
            <div className="text-center text-[10px] text-gray-400 dark:text-gray-500 mt-4 flex items-center justify-center gap-1">
